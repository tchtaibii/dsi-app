...
class TypeDachat(models.Model):
    type = models.CharField(
        max_length=100, default='Contrat Cadre', blank=False, null=False)
...
class Achats(models.Model):
    demandeur = models.CharField(max_length=100, blank=False, null=False)
    entité = models.CharField(max_length=100, blank=False, null=False)
